...
#pragma HLS UNROLL
	...
	if(!mergeClusters(preMergePeakEta[tEta][tPhi],
      ...
      //std::cout<<"After merging tEta/tPhi/peakEta/peakPhi/"<<tEta<<"/"<<tPhi<<"/"<<peakEta[tEta][tPhi]<<"/"<<peakPhi[tEta][tPhi]<<endl;0
	if(!isolation10x15(crystals[tEta][tPhi], &preMergeiso10x15ET[tEta][tPhi], &peakEta[tEta][tPhi], &peakPhi[tEta][tPhi], &towerET[tEta][tPhi])){
	  return false;
	}
